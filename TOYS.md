...
BCE supports synchronizing vibrating toys inside the club to your real remote controlled toys via [buttplug.io](https://buttplug.io).
...
- Toys may not be detected, if you power them on after signing into the club. Power on your toys first, or reload the page after powering them on. Even if detected, the previous setting will not be correctly restored.