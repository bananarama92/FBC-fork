...
## Installation
* Install the [FUSAM](https://sidiousious.gitlab.io/bc-addon-loader/) BC Addon Manager, install the Tampermonkey browser addon and then click on [loader.user.js](https://bananarama92.github.io/FBC-fork/loader.user.js)
